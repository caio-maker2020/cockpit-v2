-- ============================================================================
-- 2026-08-11_325 — RECONCILIADOR DE RESPOSTA DE CLIENTE PENDENTE (INV-066).
--
...
COMMENT ON FUNCTION public.cards_resposta_cliente_nao_acionada(integer, integer, integer) IS
  'INV-066: cards ACIONÁVEIS com resposta de cliente capturada e nunca acionada. Detector read-only do reconciliador (cron-ia-resposta-pendentes). Caio 2026-08-11.';
...
VALUES (
  ...
  false,
  'INV-066: aciona automaticamente card acionável com resposta de cliente não tratada. OFF = sombra (só lista).'
)

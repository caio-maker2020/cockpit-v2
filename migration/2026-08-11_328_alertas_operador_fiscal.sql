-- ============================================================================
-- 2026-08-11_328 — ALERTAS PRO OPERADOR + FISCAL DO INV-067.
--
-- Caio 2026-08-11: "Não podemos permitir que exista resposta dos clientes sem
-- mover card e sem o operador estar ciente." O reconciliador (mig 327) conserta
...
COMMENT ON TABLE public.alertas_operador IS
  'INV-067: avisos direcionados ao operador dono do card (não ao gestor). Aparecem como barra inferior + conversa do agente no Cockpit. Caio 2026-08-11.';
...
VALUES ('fiscal_resposta_cliente_enabled', true,
        'INV-067: fiscal que avisa o OPERADOR (e-mail + aviso no Cockpit) quando sobra resposta de cliente sem acionamento.')

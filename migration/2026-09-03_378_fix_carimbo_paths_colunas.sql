-- =============================================================================
-- 2026-09-03_378 — FIX do carimbo: fontes são COLUNAS de cards, não agent_state
-- =============================================================================
...
-- =============================================================================
-- Contraprova da 377 pegou o erro em minutos: o 1º carimbo real (NF 115984)
-- saiu sem acao_key porque aviso_alteracao_oc e ia_sugestao_oc_resposta são
-- COLUNAS próprias de cards (35 e 68 dos 216 abertos têm acao_key nelas) — o
-- path via agent_state lia NULL sempre. Mesmo REPLACE, só os paths mudam.
...
BEGIN
  ...
  SELECT jsonb_strip_nulls(jsonb_build_object(
    'agente_acao_key',        c.aviso_alteracao_oc->>'proposta_destacada_acao',
    'agente_oc',              c.aviso_alteracao_oc->>'proposta_destacada',
    'interpretador_acao_key', c.ia_sugestao_oc_resposta->>'proposta_destacada_acao',
    'interpretador_oc',       c.ia_sugestao_oc_resposta->>'oc_sugerida',
    'interpretador_em',       c.ia_sugestao_oc_resposta->>'sugerido_em',

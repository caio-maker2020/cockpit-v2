// =============================================================================
// fiscal-resposta-cliente — 3ª camada do INV-066 (Caio 2026-08-11).
//
// Camadas, nesta ordem:
//   1. vinculador                  → aciona no caminho normal
//   2. reconciliador (cron 1min)   → conserta o que a 1 não pegou (mig 325)
...
Deno.serve(async (_req) => {
  ...
  // Detector = MESMA fonte da correção automática (mig 325). Se o fiscal usasse
  ...
  for (const l of linhas) {
    ...
    await supabase.from("card_events").insert({
      ...
      payload: {
        ...
        motivo: "INV-066: resposta de cliente sem acionamento sobreviveu ao reconciliador",
      },
    });

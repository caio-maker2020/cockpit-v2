...
- [melhoria 74002948-1850-4ed0-8569-97f97cbbea52 · 2026-08-11] Quando a evidência do insucesso é inválida, a saída depende da ocorrência do card: (a) em card de ocorrência 10 (recusa) cuja ressalva não está nítida ou não tem foto, a correta é 56, solicitando a evidência à base; (b) em card de ocorrência 13 (limitação do cliente) em que é preciso aguardar o retorno do cliente para nova tentativa e o insucesso não é válido, a correta é 21 acompanhada do cancelamento da reentrega. (O ramo da ocorrência 11 fora do raio — 21 + cancelamento — foi retirado desta linha em 11/08 por já estar implementado: ver o bloco "CASO PROBLEMA COM ENDEREÇO (Padronização oc 11)" acima.)

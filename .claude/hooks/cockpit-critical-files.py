...
INV_RESUMO = {
    ...
    "INV-039": "Fila acoes_agendadas: ação que falha NUNCA fica 'pendente' com executar_em no passado (reagenda +24h com teto → precisa_acao; decisor _shared/fila-acoes-agendadas.ts). Nenhum INSERT direto de cobranca_email — só via RPC agendar_cobranca_email (flag + validação de e-mail, mig 298). Pendência eterna satura a janela LIMIT 200 e starva cancelamentos de reentrega (incidente 2026-07-16, NF 687166).",

...
INV_RESUMO = {
    ...
    "INV-039": "Fila acoes_agendadas: ação que falha NUNCA fica 'pendente' com executar_em no passado (reagenda +24h com teto 5 → cancelado + alerta; decisor _shared/fila-acoes-agendadas.ts; NUNCA precisa_acao pra cobranca_email — status invisível pra esse tipo). Nenhum INSERT direto de cobranca_email — só via RPC agendar_cobranca_email (flag, mig 298; marcar_retorno_inconclusivo incluso). Pendência eterna satura a janela LIMIT 200 e starva cancelamentos de reentrega (incidente 2026-07-16, NF 687166).",

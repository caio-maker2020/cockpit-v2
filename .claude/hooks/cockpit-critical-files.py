...
INV_POR_ARQUIVO = {
    ...
    "supabase/functions/executor/index.ts": ["INV-002", "INV-008", "INV-011", "INV-039"],
    "supabase/functions/processar-acoes-agendadas/index.ts": ["INV-039"],
    "supabase/functions/_shared/fila-acoes-agendadas.ts": ["INV-039"],
...
INV_RESUMO = {
    ...
    "INV-039": "Fila acoes_agendadas: ação que falha NUNCA fica 'pendente' com executar_em no passado (reagenda +24h com teto 5 → cancelado + alerta; decisor _shared/fila-acoes-agendadas.ts; NUNCA precisa_acao pra cobranca_email — status invisível pra esse tipo). Cobrança automática APAGADA (2026-07-17, mig 298, sem flag): NENHUM código pode criar cobranca_email — religar = migration nova + ADR. Pendência eterna satura a janela LIMIT 200 e starva cancelamentos de reentrega (incidente 2026-07-16, NF 687166).",
